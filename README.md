...
Reto diario al estilo Wordle. Cada día salen siete preguntas abiertas, las mismas para todo el mundo ("Nombra una tapa", "Nombra un río de España"). Vale cualquier respuesta correcta, pero cuanto más rara sea, más metros bajas por el iceberg. Si solo dices lo obvio, te quedas en la punta.

Ninguna pregunta exige haberse criado fuera de España: nada de cadenas de donuts ni de cereales que aquí no se venden.
