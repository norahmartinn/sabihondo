...
- Las preguntas y respuestas salen de `datos/banco.csv` (73 preguntas, 3.285 respuestas con su nivel y la fuente de cada lista). `python3 scripts/banco.py` lo convierte y lo mete en `index.html`: arregla enunciados y añade alias (por ejemplo, "Asturias" para "Principado de Asturias" o "Hamilton" para "Lewis Hamilton").
